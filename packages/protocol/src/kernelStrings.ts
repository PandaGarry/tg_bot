...
export const kernelStrings = {
  ru: {
    ...
    "kernel.unit.between-windows": "Это событие ещё не началось",
    "kernel.unit.quarantine": "Этот узел чинится, зайдите позже",
  ...
  en: {
    ...
    "kernel.unit.between-windows": "This event has not started yet",
    "kernel.unit.quarantine": "This node is being mended, come back later",
